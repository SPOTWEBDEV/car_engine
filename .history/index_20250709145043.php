                                        ...
                                        <div class="swiper-slide">
                                            <div class="review-wrapper3">
                                                ...
                                                <div class="inner d-flex align-items-start">
                                                    ...
                                                    <div class="content">
                                                        <p class="desc cw">
                                                   "I was nervous about buying a used engine online, but <?php echo  made the process stress-free. The engine came with a warranty, was clean, and worked right out of the box. Totally trustworthy!"
                                                        </p>
                                                        <ul class="star-rating">
                                                            <li class="cw"><i class="rt-icon-star"></i></li>
                                                            <li class="cw"><i class="rt-icon-star"></i></li>
