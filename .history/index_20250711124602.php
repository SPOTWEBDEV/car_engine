            ...
            <section class="rts-banner-slider-area">
                <div class="swiper bannerSlider">
                    ...
                    <div class="swiper-btn-area">
                        <div class="swiper-btn swiper-button-prev"><img src="assets/images/04.jpg" alt=""></div>
                        <div class="swiper-btn swiper-button-next"><img src="assets/images/assets/images/04.jpg" alt=""></div>
                    </div>
                </div>
            ...
            <section style="margin-top:30px" class="rts-portfolio-area2 area-3 rts-section-gapBottom">
                <div class="container">
                    ...
                    <div class="section-inner mt--80 wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                        <div class=" tab-content" id="myTabContent">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="project-wrapper4">
                                                    <div class="image-area">
                                                        <a href="shop-details.html"><img src="<?php echo $product_image ?>" alt=""></a>
                                                    </div>
                                                    <div class="content-area">
                                                        ...
                                                        <h6 class="title "><a href="shop-details.html"><?php echo $row['title'] ?></a>
                                                        </h6>
                                                        <div class="button-area">
                                                            <p class="">In-Store Purchase Only</p>
                                                            <a style="display:none" href="cart.html" class="rts-btn btn-primary radius-big icon">
                                                                Add To Cart
                            ...
                            <div class="tab-pane fade" id="used" role="tabpanel" aria-labelledby="used-tab">
                                <div class="row g-5">
                                    ...
                                    $query = mysqli_query($connection, "SELECT * FROM `product` WHERE `status`='instock' ORDER BY RAND() LIMIT 6");
                        ...
                        <a href="<?php echo $domain ?>shop/" class="rts-btn radius-big btn-border load-more-btn">Load More</a>
                    </div>
                </div>
            </section>
            <!-- Portfolio Area End -->
