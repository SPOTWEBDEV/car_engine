...
<!-- Mirrored from html.themewant.com/autovault/index-four.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Jul 2025 16:57:11 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<?php echo $ assets/css/plugins/plugins.css">
...
<body class="home-four">
    ...
    <div class="rts-wrapper">
        <div class="rts-wrapper-inner">
            ...
            <header class="header-four header--sticky">
                <div class="header-top">
                    <div class="container">
                        <div class="inner">
                            <div class="logo-area">
                                <a href="index-2.html"><img src="assets/images/logo/logo.svg" width="99" alt=""></a>
                            </div>
                            <div class="get-touch-area">
                                <div class="map-area">
                                    ...
                                    <div class="text">
                                        <p>Call Us Now</p>
                                        <a href="call-to_12505550199">+12505550199</a>
                                    </div>
                                </div>
                                <div class="map-area">
                                    <div class="icon">
                            ...
                            <div class="button-area d-flex">
                                <a href="cart.html" class="rts-btn btn-border radius-big icon">
                                    Sign In
                                            ...
                                            <ul class="">
                                                <li class="has-dropdown main-nav">
                                                    ...
                                                    <ul class="submenu parent-nav">
                                                        <li><a href="index-2.html">Dealer One</a></li>
            ...
            <!-- Category Area Start -->
            <section class="rts-category-area2 rts-section-gapTop">
                <div class="container">
                    <div class="section-title-area2">
                        <p class="sub-title wow fadeInUp" data-wow-delay=".1s" data-wow-duration=".8s">Parts Category</p>
                        <h2 class="section-title wow move-right">Shop By <span>Categories</span></h2>
                    </div>
                    <div class="section-inner wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                        <div class="swiper categorySlider2">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="category-wrapper">
                                        <div class="icon">
                                            <img src="assets/images/category/13.svg" alt="">
                                        </div>
                                        <h6 class="title"><a href="#">Engine Oils</a></h6>
                                        <p class="desc"><a href="shop.html">Shop Now</a></p>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="category-wrapper">
                                        <div class="icon">
                                            <img src="assets/images/category/14.svg" alt="">
                                        </div>
                                        <h6 class="title"><a href="#">Electrical Parts</a></h6>
                                        <p class="desc"><a href="shop.html">Shop Now</a></p>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="category-wrapper">
                                        <div class="icon">
                                            <img src="assets/images/category/15.svg" alt="">
                                        </div>
                                        <h6 class="title"><a href="#">Car Tyre</a></h6>
                                        <p class="desc"><a href="shop.html">Shop Now</a></p>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="category-wrapper">
                                        <div class="icon">
                                            <img src="assets/images/category/16.svg" alt="">
                                        </div>
                                        <h6 class="title"><a href="#">Body Parts</a></h6>
                                        <p class="desc"><a href="shop.html">Shop Now</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-5">
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="why-choose-us-wrapper">
                                    ...
                                    <p class="desc">Daily, weekly, and long-term and rentals available With multiple locations across</p>
                                    <div class="icon">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="why-choose-us-wrapper">
                                    <h6 class="title">Easy Online Booking</h6>
                                    <p class="desc">Simple online booking process with quick pickup and drop-off at multiple locations.</p>
                                    <div class="icon">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="why-choose-us-wrapper">
                                    ...
                                    <p class="desc">With multiple locations across dropping off your rental car at multiple locations.</p>
                                    <div class="icon">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="why-choose-us-wrapper">
                                    <h6 class="title">Top-Notch Customer</h6>
                                    <p class="desc">Our professional and friendly staff is dedicated to making your rental experience</p>
                                    <div class="icon">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-xl-5 col-lg-6">
                                <div class="contact-form">
                                    <h5>Get In Touch</h5>
                                    <form class="form__content" method="post" action="https://html.themewant.com/autovault/mailer.php" id="contact-form">
...
<!-- Mirrored from html.themewant.com/autovault/index-four.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Jul 2025 16:57:32 GMT -->
</html>